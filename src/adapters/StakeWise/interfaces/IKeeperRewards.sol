...
interface IKeeperRewards is IKeeperOracles {
    ...
    struct HarvestParams {
        bytes32 rewardsRoot;
        int192 reward;
        uint192 unlockedMevReward;
        bytes32[] proof;
    }
    // 104 + proof lenght 32 and struct location 32
    // 104 + 32 + 32 = 168
     ...
     */
    function harvest(HarvestParams calldata params) external returns (int256 totalAssetsDelta, uint256 unlockedMevDelta, bool harvested);

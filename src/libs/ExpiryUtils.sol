...
// Extract from pendle-core-v2-public/contracts/core/libraries/ExpiryUtilsLib.sol
...
library ExpiryUtils {
     ...
     *
     */
    function concat(string memory _bt, string memory _yt, uint256 _expiry, string memory _delimiter) internal pure returns (string memory result) {
    ...
    function monthName(Date memory d) public pure returns (string memory) {
